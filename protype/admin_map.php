...
<script>
    ...
    function initMap() {
        27.70169, 85.3206
        var france = {lat: 27.70169, lng: 85.3206};
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBISQUK7ltRgWLOhmn_9iAInDNP4cQpmr0&callback=initMap">
</script>