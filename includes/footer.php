...
<footer>
		      <div class="container">
					 ...
					 <ul class="links">
							...
							<li><a href="https://twitter.com/sandesht801" onclick="_gaq.push(['_trackEvent', 'exit', 'footer', 'Twitter']);"><span class="fa fa-twitter"></span> Twitter</a></li>
							<li><a href="https://plus.google.com/107898667643787369007" onclick="_gaq.push(['_trackEvent', 'exit', 'footer', 'Google+']);"><span class="fa fa-google"></span> Google+</a></li>
				     </ul>
			  </div>
 </footer>