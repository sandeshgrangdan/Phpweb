		 ...
		 <div class="col-lg-10">
				 ...
				 <div class="col-md-3">
					 <div class="card card-danger"> 
						 <div class="card-heading">
							 <div class="row">
								 <div class="col-sm-3"><i class="fa fa-signal" style="font-size:4.5em"></i></div>
					 ...
					 <a href="view_post.php">
						 <div class="card-footer">
							 ...
							 <div class="pull-right"><i class="fa fa-circle-arrow-right"></i></div>
				 ...
				 <div class="col-md-3">
					 <div class="card card-info"> 
						 <div class="card-heading">
							 <div class="row">
								 <div class="col-sm-3"><i class="fa fa-th-list" style="font-size:4.5em"></i></div>
		 						 <div class="col-xs-9 text-right">
				 ...
				 <div class="card card-success"> 
					 <div class="panel-heading">
						 <div class="row">
							 <div class="col-sm-3"><i class="fa fa-user" style="font-size:4.5em"></i></div>
							 <div class="col-xs-9 text-right">
			 ...
			 <!-- <div class="col-md-3">
				 <div class="card card-primary"> 
					 <div class="panel-heading">
						 <div class="row">
							 <div class="col-sm-3"><i class="fa fa-comment" style="font-size:4.5em"></i></div>
							 <div class="col-xs-9 text-right">
